...
- (void)configTitleView
{
    ...
    _titleBackgroundView.alpha = 0.6;
    ...
    if (showPageIndicator) {
        ...
        _pageControl= [[UIPageControl alloc] initWithFrame:CGRectMake(250, 15, 320-250, 10)];
    ...
    _titleBackgroundView.hidden = YES;
...
- (void)showTitleBar
{
    _titleBackgroundView.hidden = NO;
}
