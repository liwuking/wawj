...
+(NSString *)getDayWeek{
    ...
    long minute=[comps minute];//获取分对应的长整形字符串
    ...
    NSString *dayStr = month < 10 ? [NSString stringWithFormat:@"0%ld",day] : [NSString stringWithFormat:@"%ld",day];
    NSString *riQi =[NSString stringWithFormat:@"%@月%@日 %@",monthStr,dayStr,weekDay];//把日期长整形转成对应的汉字字符串
