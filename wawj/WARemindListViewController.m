...
@interface WARemindListViewController ()<UITableViewDelegate,UITableViewDataSource,RemindCellDelegate>
{
...
@implementation WARemindListViewController
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"end_remind.png"] style:UIBarButtonItemStyleDone target:self action:@selector(leftAction)];
    self.navigationItem.leftBarButtonItem = leftItem;
    self.navigationItem.leftBarButtonItem.tintColor = [UIColor whiteColor];
    
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc]initWithTitle:@"新建" style:UIBarButtonItemStyleDone target:self action:@selector(rightAction)];
